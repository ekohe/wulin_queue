if defined? WulinMaster
  class SolidQueueProcessGrid < WulinMaster::Grid
    ...
    # Every process kind — Supervisor, Dispatcher, Scheduler and Worker. Filtering
    # this down to workers (what mission_control did) hides the two processes that
    # actually explain a stalled queue.
